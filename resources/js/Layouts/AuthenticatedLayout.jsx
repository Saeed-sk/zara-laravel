...
export default function Authenticated({user, header, children}) {
    ...
    return (
        <div className="min-h-screen bg-gray-900 grid grid-rows-[70px_1fr]">
                                ...
                                <Dropdown>
                                    <Dropdown.Trigger>
                                        <span className="inline-flex rounded-md">
                                            <button
                                                type="button"
                                                className="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-mdv text-gray-400 bg-gray-800 hover:text-gray-300 focus:outline-none transition ease-in-out duration-150"
                                            >
                                                {user.name}
                ...
                <div className={(showingNavigationDropdown ? 'block' : 'hidden') + ' sm:hidden'}>
                    ...
                    <div className="pt-4 pb-1 border-t border-gray-600">
                        <div className="px-4">
                            ...
                            <div className="font-medium text-sm text-gray-500">{user.phone}</div>
                        </div>
